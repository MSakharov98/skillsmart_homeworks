...
# Задание 1.3
'''
Продемонстрируем наглядное поведение при передачае объектов по ссылке
'''

# У нас есть объект mac_book_pro_16. Представим, что мы решили приобрести другой ноутбук
mac_book_pro_14 = mac_book_pro_16

# С помощью двух проверок мы наблюдаем, что два ноутбука идентичны.
# Они ссылаются на одну и ту же ячейку в памяти компьютера.
print(mac_book_pro_16 is mac_book_pro_14)
print(mac_book_pro_16 == mac_book_pro_14)
